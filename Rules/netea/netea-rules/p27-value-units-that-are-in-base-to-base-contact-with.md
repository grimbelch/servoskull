> Source: Netea Rules, p.27 (netea-rules-2026-02-05.pdf)

# value. Units that are in base-to-base contact with the enemy use

NetEA Rules - 2026-02-05

Epic Game Rules

value. Units that are in base-to-base contact with the enemy use the close combat value, while units that are not in base contact but are within 15cm and have a line of fire to the enemy can use their firefight value. Units that are armed only with close combat weapons and do not have any small arms or other ranged weapons may only attack if in base contact with the enemy.
