> Source: Netea Tournament Pack, p.12 (netea-tournament-pack-2026-02-09.pdf)
...
**II -** Declare which action it will carry out. **III -** The formation must then pass an action test to see if it carries out the action successfully.
...
**Sustained Fire:** The formation may not move (not even to turn in place), but can shoot with a +1 modifier. You may not choose this action if the formation has any units that are out of formation.
