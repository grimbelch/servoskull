> Source: Netea Rules, p.7 (netea-rules-2026-02-05.pdf)

# noted here. An explanation of what effect these rules have can

NetEA Rules - 2026-02-05

Epic Game Rules

noted here. An explanation of what effect these rules have can be found in sections 2.0-4.0.

Datasheets for units from the Epic Game can be found in Section 5.0.
...
Examples of Formations<br><!-- End of picture text -->
