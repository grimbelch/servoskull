> Source: Netea Eldar Iyanden, p.6 (netea-eldar-iyanden-2026-02-03.pdf)

# Holofield:

**SPECIAL RULE** **_Eldar Technology_**<sup>_2_</sup>
...
- Q: If units from an Eldar formation are in an enemy's zone of control and take an advance or double action can they shoot first and then move?

- A: Yes. 2. Eldar Technology

- Q: Is a Holofield affected by save modifiers (i.e. hits from sniper and crossfire)?
