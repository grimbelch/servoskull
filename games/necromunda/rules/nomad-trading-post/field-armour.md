> Source: https://www.necroraw.com.ru/docs/nomad-trading-post/field-armour

# Field Armour

[RAW ✔️](/docs/publication-index/rules-index) *Tribes of the Wastelands, p101*

Any fighter may wear one or more types of field armour. These provide an alternative to conventional armour
and may be worn as well as conventional armour. The save they offer cannot be modified by a weapon's Armour
Piercing value. However, a fighter can only make one save attempt per attack, therefore the controlling player
must choose to either make a save attempt using the fighter's armour save, or using a field.

### Conversion field

[RAW ✔️](/docs/publication-index/rules-index) *Tribes of the Wastelands, p101*  
**60 Credits – Scavenge (12)**
...
When a fighter wearing a refractor field is hit by an attack, roll a
