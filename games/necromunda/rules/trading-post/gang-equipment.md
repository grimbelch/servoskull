> Source: https://www.necroraw.com.ru/docs/trading-post/gang-equipment
...
[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p278*  
**60 Credits – Rare (8)**
...
gang's Stash. During the battle, ammo caches follow the rules given in [Scenario Rules: Ammo Cache](/docs/battlefield-set-up/scenario-rules#ammo-cache).
...
booby trap does not go off but is left in place. On a 4, 5 or 6,
the booby trap is triggered and will explode. The profiles for
booby traps can be found in the [Trading Post](/docs/trading-post/booby-traps).
The movement of a moving model is interrupted
...
Territory they control into a Settlement Territory. Doing so uses up
the Isotropic Fuel Rod, so it should be deleted from the
gang roster, and permanently changes the Territory.

### Mung vase

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p279*  
...
[RAW ✔️](/docs/publication-index/rules-index) *The Book of Ruin, p123*  
**Corpse Grinder only**

Only one fighter in a gang may carry a Corpse
Grinder cult icon, this must be either the gang Leader
or a Champion. A fighter cannot carry more than
one icon. This symbol of blood and gore serves to
work members of the cult into a frenzy, throwing
themselves at their enemies in a crimson rage. If the
fighter carrying this icon is Standing and Active, they
may make the following action:

**Enrage:** All friendly fighters that are completely
within 6" of this fighter, that have a Ready marker, and
that are Standing and Active, add D3" to their Move
characteristic until the End phase of this round.
