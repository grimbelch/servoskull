> Source: https://www.necroraw.com.ru/docs/battlefield-set-up/rolling-roads

# Rolling Roads

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p202*
...
vehicle is forced to hit the sides, resolve it as if it were a [collision against impassable terrain](/docs/the-rules/game-structure/the-action-phase/vehicle-impacts#colliding-with-terrain).
