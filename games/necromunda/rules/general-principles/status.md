> Source: https://www.necroraw.com.ru/docs/general-principles/status

# Status

## Fighter Status

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p64*
...
and Engaged, though they do count as having had to [Turn to Face](/docs/the-rules/game-structure/the-action-phase/close-combat#1-turn-to-face). A fighter can never be both Prone and Pinned and Engaged.
...
[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p65*
...
can often fire their weapons, but must 'Restart' (see [Stationary & Stalled Vehicles](/docs/the-rules/game-structure/the-action-phase/vehicle-actions#stationary--stalled-vehicles)) before they can move off.
