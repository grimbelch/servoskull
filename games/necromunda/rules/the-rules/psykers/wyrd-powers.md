> Source: https://www.necroraw.com.ru/docs/the-rules/psykers/wyrd-powers

# Wyrd Powers

[RAW ✔️](/docs/publication-index/rules-index) *Book of the Outcast, p52*

This section, designed to work alongside the [rules for
psykers presented in the Necromunda Rulebook](/docs/the-rules/psykers/), greatly
...
- [Bounty Hunters](/docs/gangs/gang-additions/hired-guns/bounty-hunters/#0-1-bounty-hunters) and [Venator Hunt Leaders](/docs/gangs/gang-lists/venator-bounty-hunter-gangs/#-venator-hunt-leader) can be upgraded
  when hired to have the Sanctioned Psyker or Non-sanctioned Psyker special rule (as chosen by the
...
- A Sanctioned Psyker or Non-sanctioned Psyker
  ...
  as an Advancement (either by generating a power randomly for 9 XP, or choosing one for 12 XP).
...
| D6 [Biomancy](#biomancy-discipline) [Chronomancy](#chronomancy-discipline) [Divination](#divination-discipline) [Pyromancy](#pyromancy-discipline) |
| --- |
| 1 [Arachnosis](#1-arachnosis-basic-continuous-effect) [Freeze Time](#1-freeze-time-double) [Precognition](#1-precognition-special) [Body of Flame](#1-body-of-flame-basic-continuous-effect) |
| 2 [Chameleon](#2-chameleon-basic-continuous-effect) [Suppress Power](#2-suppress-power-basic) [Foreboding](#2-foreboding-double-continuous-effect) [Stoke Flames](#2-stoke-flames-basic) |
| 3 [Cause Pain](#3-cause-pain-basic) [Zen Shootist](#3-zen-shootist-basic-continuous-effect) [Misfortune](#3-misfortune-basic) [Wall of Flame](#3-wall-of-flame-basic-continuous-effect) |
| 4 [Stop Bleeding](#4-stop-bleeding-basic) [Walk Through Walls](#4-walk-through-walls-double) [Forewarning](#4-forewarning-basic) [Flame Blast](#4-flame-blast-basic-continuous-effect) |
| 5 [Quickening](#5-quickening-basic-continuous-effect) [Mirror Image](#5-mirror-image-basic) [Warp Whispers](#5-warp-whispers-special) [Molten Bolt](#5-molten-bolt-basic) |
| 6 [Iron Arm](#6-iron-arm-basic-continuous-effect) [Lucky Aura](#6-lucky-aura-basic-continuous-effect) [Visions](#6-visions-double-continuous-effect) [Scouring](#6-scouring-basic-continuous-effect) |

| D6 [Technomancy](#technomancy-discipline) [Telekinesis](#telekinesis-discipline) [Telepathy](#telepathy-discipline) |
| --- |
| 1 [Weapon Jinx](#1-weapon-jinx-simple) [Assail](#1-assail-basic) [Mind Control](#1-mind-control-basic-continuous-effect) |
| 2 [Overcharge](#2-overcharge-basic-continuous-effect) [Crush](#2-crush-basic) [Terrify](#2-terrify-double) |
| 3 [Hardening](#3-hardening-basic-continuous-effect) [Force Field](#3-force-field-basic-continuous-effect) [Invisibility](#3-invisibility-double-continuous-effect) |
| 4 [Manipulate Door](#4-manipulate-door-simple) [Hailstorm](#4-hailstorm-basic) [Mental Assault](#4-mental-assault-basic) |
| 5 [Manipulate Lumens](#5-manipulate-lumens-double) [Force Blast](#5-force-blast-basic) [Hallucinations](#5-hallucinations-basic) |
| 6 [Crack Lock](#6-crack-lock-basic) [Levitation](#6-levitation-basic-continuous-effect) [Unbreakable Will](#6-unbreakable-will-basic-continuous-effect) |
...
While this Wyrd Power is maintained, the fighter counts as having the Clamber, Catfall and Mighty Leap skills.
...
*The ability to peer into the future is something common to many wyrds, for it is believed that the Warp, and its denizens, do not obey the normal constraints of time and space. Diviners, as wyrds talented in this discipline are known, are in high
demand among the gangs and organisations of the underhive; for who wouldn't want to be able to look into the future and anticipate the actions of their enemies before they even happen?*
...
While this Wyrd Power is maintained, the fighter may either gain the Overwatch skill or grant the
...
*A strange and rare power, technomancy is the ability to psychically manipulate technology of all kinds. Technomancers, as wyrds who command these abilities are known, can with a mere thought cause weapons to fail or operate far past their
peak performance, or harden a suit of armour. In the depths of the underhive, a technomancer is truly in their element, as they use their powers to turn the very battlefield against their enemies.*
...
The [Pitch Black rules](/docs/battlefield-set-up/scenario-rules#pitch-black--visibility) immediately come into effect, or immediately end if they were already in effect.
...
If a wyrd only selects powers from the Telekinesis discipline, they gain the Fists of
Fury special rule:

**Fists of Fury:** When this fighter makes an unarmed attack, increase both the Strength and Damage characteristics of the attack by 1.
