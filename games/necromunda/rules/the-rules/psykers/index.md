> Source: https://www.necroraw.com.ru/docs/the-rules/psykers/

# Psykers

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p153*
...
**Wyrd Powers:** If a Sanctioned or Non-sanctioned
Psyker does not know any Wyrd Powers, they may
select one from either the list on page 156 or from
the Wyrd Power Disciplines in Necromunda: Book of
the Outcast.
...
[The *Book of the Outcast* section](/docs/the-rules/psykers/wyrd-powers), designed to work alongside the rules for
psykers presented in the Necromunda Rulebook, greatly
expands upon the Wyrd Powers available to players and
Arbitrators in their games.
