> Source: https://www.necroraw.com.ru/docs/the-rules/the-post-battle-sequence

# The Post-Battle Sequence

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p142*
...
**1. [Wrap-up](#1-wrap-up)**  
**2. [Assign/Reassign Territory](#2-assignreassign-territory)**  
**3. [Receive Rewards](#3-receive-rewards)**  
**4. [Collect Income](#4-collect-income)**  
**5. [Post-battle Actions](#5-post-battle-actions)**  
**6. [Update Roster](#6-update-roster)**  
...
as possible, and must delete the Captive fighter from their roster. All weapons and equipment owned by the
fighter are sold along with them, they do not go into any
gang's Stash.

### Claim Bounties

As described in [Captive Fighters](/docs/the-rules/the-post-battle-sequence#captive-fighters), Law Abiding gangs can
claim bounties for any enemy fighters belonging to
...
The gang can visit the Trading Post to spend its hard-earned credits in any of the ways described below, allowing them to hire new fighters and buy or sell
...
of Rare and Illegal items on offer at the [Trading Post](/docs/trading-post/). Roll 2D6 to determine the availability
