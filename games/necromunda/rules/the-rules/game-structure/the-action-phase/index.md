> Source: https://www.necroraw.com.ru/docs/the-rules/game-structure/the-action-phase/

# The Action Phase

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p101*
...
- Sometimes a model may only be able to perform one
  ...
  action it can choose to perform are limited to Simple, Basic and Free (see [Types of Action](/docs/the-rules/game-structure/the-action-phase/types-of-action)).
