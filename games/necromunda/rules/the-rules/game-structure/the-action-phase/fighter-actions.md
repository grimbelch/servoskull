> Source: https://www.necroraw.com.ru/docs/the-rules/game-structure/the-action-phase/fighter-actions

# Fighter Actions

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p103*
...
- [Climb](/docs/the-rules/game-structure/the-action-phase/terrain#climbing) vertically upwards or downwards.
- Cross any gap between two platforms that is no wider than their base.
- Attempt to [leap across a bigger gap](/docs/the-rules/game-structure/the-action-phase/terrain#leaping-gaps) provided that they have enough movement left to do so.
- Attempt to [jump down](/docs/the-rules/game-structure/the-action-phase/terrain#jumping-down) to a level below.
...
The fighter makes an attack with a ranged weapon – see [Shooting](/docs/the-rules/game-structure/the-action-phase/shooting).
...
If this fighter is within 1" of a locked door, roll a D6
and add either this fighter’s Strength or the Strength
characteristic of a weapon with the Melee trait they are
armed with, adding 2 for each friendly fighter that is
also in base contact with the door.
If the total is 9 or more, the door
is opened.

### Smash Open Loot Casket (Basic)

If this fighter is within 1" of a Loot Casket, roll a D6 and
add either their Strength or the Strength characteristic
of a weapon with the Melee trait they are armed with.
If the total is 6 or more, the casket is opened.
However, subtract 1 from the roll to determine
the casket's contents, to a minimum
of 1 (see [Opening Loot Caskets](/docs/battlefield-set-up/scenario-rules#opening-loot-caskets)).
...
The fighter makes close combat attacks against one or more enemy fighters they are engaged with (see [Close Combat](/docs/the-rules/game-structure/the-action-phase/close-combat)).
