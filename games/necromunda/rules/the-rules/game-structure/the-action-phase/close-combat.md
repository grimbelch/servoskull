> Source: https://www.necroraw.com.ru/docs/the-rules/game-structure/the-action-phase/close-combat

# Close Combat

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p120*
...
Hit rolls may be modified by +1 for each assist from a
...
Each attack that scores a hit is resolved as described in [Resolving Hits](/docs/the-rules/game-structure/the-action-phase/resolve-hits).
...
close combat attacks, a fighter can claim 'assists' from
friendly fighters who are also engaged with the target
