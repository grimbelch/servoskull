> Source: https://www.necroraw.com.ru/docs/the-rules/game-structure/the-action-phase/vehicle-actions

# Vehicle Actions

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p106*
...
- Cross any gap between two platforms that is no wider than the length of the vehicle as long as the initial platform isn't lower than the target platform (if they try to cross a bigger gap, they will [fall](/docs/the-rules/game-structure/the-action-phase/terrain#vehicles-and-falling)).
- Cross certain terrain features – see [Vehicles and Difficult Terrain](/docs/the-rules/game-structure/the-action-phase/terrain#vehicles-and-difficult-terrain).
...
pistol. A vehicle cannot perform both this and the
...
a [Loss of Control test](/docs/the-rules/game-structure/the-action-phase/resolve-hits-against-vehicles#loss-of-control-tests) applying a
+1 modifier.
...
can move. If, during this movement, it has a head-on collision with another vehicle or a terrain feature, this vehicle halves its Movement characteristic when
...
[Loss of Control test](/docs/the-rules/game-structure/the-action-phase/resolve-hits-against-vehicles#loss-of-control-tests).
...
[Loss of Control test](/docs/the-rules/game-structure/the-action-phase/resolve-hits-against-vehicles#loss-of-control-tests) with a -1 modifier.
...
Action and fighters on board might have been [thrown clear](/docs/the-rules/game-structure/the-action-phase/resolve-hits-against-vehicles#thrown-clear), and the vehicle itself has been
