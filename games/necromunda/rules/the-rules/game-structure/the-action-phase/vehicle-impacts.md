> Source: https://www.necroraw.com.ru/docs/the-rules/game-structure/the-action-phase/vehicle-impacts

# Vehicle Impacts

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p109*
...
by the [Vehicle Collision Damage table](/docs/the-rules/game-structure/the-action-phase/vehicle-impacts#vehicle-collision-damage-table). All
...
discussed later (see [Resolving Hits Against Vehicles](/docs/the-rules/game-structure/the-action-phase/resolve-hits-against-vehicles)).
