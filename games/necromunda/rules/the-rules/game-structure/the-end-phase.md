> Source: https://www.necroraw.com.ru/docs/the-rules/game-structure/the-end-phase

# The End Phase

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p139*
...
the total number of models in its starting crew (the number of models that were present at the start of the battle, see [Choosing Crews](/docs/battlefield-set-up/scenario-rules#choose-crew)), the Bottle check is failed and the
...
wise for a gang to quit a fight while they are still ahead.
This is especially true in ambushes, and when smaller
...
immediately flee the battlefield as described above.
Engaged fighters must attempt to break away from
combat – make an Initiative test for each. If the test
is passed, they flee the battlefield.
If the test is failed, they become Prone and Seriously Injured. Once
...
a D6 is rolled for that driver, as described in [Crew Damage Table: Drive Wounded](/docs/the-rules/game-structure/the-action-phase/resolve-hits-against-vehicles#crew-damage-table).
