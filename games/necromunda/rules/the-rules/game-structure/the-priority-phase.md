> Source: https://www.necroraw.com.ru/docs/the-rules/game-structure/the-priority-phase

# The Priority Phase

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p100*

The Priority phase is split into the following steps:

**1. Roll For Priority:** Both players roll for Priority.  
**2. Ready Gang:** Both players give each of their
