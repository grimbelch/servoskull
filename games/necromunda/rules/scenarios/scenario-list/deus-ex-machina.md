> Source: https://www.necroraw.com.ru/docs/scenarios/scenario-list/deus-ex-machina

# 72. Deus Ex Machina

[RAW ✔️](/docs/publication-index/rules-index) *House of Artifice, p102*

Designer's Note: Death For All!
...
> *A cruel intelligence stirs deep within the underhive.*

## Battlefield

This scenario uses the [Battlefield set-up guidelines](/docs/battlefield-set-up), as described in the Necromunda Rulebook.
...
crew, as described in the [Battlefield Set-up & Scenarios section](/docs/battlefield-set-up/scenario-rules) of the Necromunda Rulebook.

The attacker uses the Custom Selection (10) method to choose their
...
as described in the [Necromunda Rulebook](/docs/battlefield-set-up/scenario-rules#deployment).
...
- [Sector Mechanicus Scenario](/docs/tags/sector-mechanicus-scenario)- [Zone Mortalis Scenario](/docs/tags/zone-mortalis-scenario)- [House Van Saar Scenario](/docs/tags/house-van-saar-scenario)
