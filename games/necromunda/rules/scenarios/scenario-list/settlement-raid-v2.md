> Source: https://www.necroraw.com.ru/docs/scenarios/scenario-list/settlement-raid-v2

# 98. Settlement Raid

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda: Core Rulebook (2023), p212; originally published in Necromunda: Ash Wastes Rulebook*

NecroRAW

Do not confuse this Ash Wastes scenario with the Outlander scenario also titled
"[Settlement Raid](/docs/scenarios/scenario-list/settlement-raid)" published in *Book of the Outcast*.
...
a battlefield, as described in the [Battlefield Set-up & Scenarios section](/docs/battlefield-set-up). The battlefield should
...
crew, as described in the [Scenario Rules: Choose Crew section](/docs/battlefield-set-up/scenario-rules).
The attacker uses the Custom
...
as described in [Scenario Rules: Gang Tactics](/docs/battlefield-set-up/scenario-rules#gang-tactics).
...
The defender has the Home Turf Advantage as described
in the Battlefield Set-up & Scenarios section.
...
- [Ash Wastes Scenario](/docs/tags/ash-wastes-scenario)- [Home Turf Advantage Scenario](/docs/tags/home-turf-advantage-scenario)
