> Source: https://www.necroraw.com.ru/docs/scenarios/scenario-list/shootout

# 15. Shootout

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda: Core Rulebook (2023), p246; originally published in Necromunda: Rulebook (2018)*
...
a battlefield, as described in the [Battlefield Set-up & Scenarios section](/docs/battlefield-set-up). The table size
...
crew, as described in the [Scenario Rules: Choose Crew section](/docs/battlefield-set-up/scenario-rules). Both gangs use the Hybrid
...
- [Underhive Scenario](/docs/tags/underhive-scenario)- [Arbitrator Scenario](/docs/tags/arbitrator-scenario)
