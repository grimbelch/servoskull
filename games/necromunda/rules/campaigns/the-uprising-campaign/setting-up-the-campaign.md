> Source: https://www.necroraw.com.ru/docs/campaigns/the-uprising-campaign/setting-up-the-campaign

# Setting Up The Campaign

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda: Apocrypha Necromunda (2024), p76*
...
![](/assets/images/gang-roster-d3da74fe052320f88ee6a49d3d333593.jpg)
...
*\*Players should note that Genestealer Cults have their own insidious agendas and often hide in plain sight, masquerading as loyal Imperial subjects. The machinations of Chaos are anathema to such alien plans, and so Genestealer Cults will readily take up arms to help quell such an uprising, strengthening their own power in doing so…*
...
| 4-5 | Play [Meat Harvest](/docs/scenarios/scenario-list/meat-harvest) or [Scavenge](/docs/scenarios/scenario-list/scavenge). |
| 6-7 | Play [Hit and Run](/docs/scenarios/scenario-list/hit-and-run) or [Show of Force](/docs/scenarios/scenario-list/show-of-force). |
| 8-9 | Play [Search and Destroy](/docs/scenarios/scenario-list/search-and-destroy). |
