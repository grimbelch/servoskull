> Source: https://www.necroraw.com.ru/docs/campaigns/the-dominion-campaign/using-the-campaign

# Using The Campaign

[RAW ✔️](/docs/publication-index/rules-index) *Necromunda Core Rulebook (2023), p165*

The Dominion Campaign is based around gangs fighting battles for the control of Territory.
Each battle in the campaign is fought for the control of a Territory,
with the winner either gaining a new Territory, or holding onto one that they already have.
...
gang. This can be any gang currently available from any
