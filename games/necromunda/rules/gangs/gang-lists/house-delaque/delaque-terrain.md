> Source: https://www.necroraw.com.ru/docs/gangs/gang-lists/house-delaque/delaque-terrain

# Delaque Terrain

[RAW ✔️](/docs/publication-index/rules-index) *House of Shadow, p101*
...
*House Delaque use a variety of traps to ensnare or disable their foes, such as sightblind traps that let off intensive bursts of light and sound to confuse and disorientate enemies.*

Sightblind traps can be set up anywhere on the battlefield outside of your opponent's deployment zone. A Sightblind Trap is a Hidden Trap and has the following weapon profile:
...
*House Delaque use a variety of traps to ensnare or disable their foes, these include Web Traps, designed to unleash a shower of binding webs – perfect for capturing prey that wander into their domains.*

Web traps can be set up anywhere on the battlefield outside of your opponent's deployment zone. A Web Trap is a Hidden Trap and has the following weapon profile:
