> Source: Grey Knights, p.7 (eng_08-06_warhammer40000_faction_pack_grey_knights-geqfqwt3wh-g2fikyrqup.pdf)

# GREY KNIGHTS THUNDERHAWK GUNSHIP

**Profile (stats):**
- M 20", T 12, SV 2+, W 30, LD 6+, OC 0

|**RANGED WEAPONS**|**RANGE**|**A**|**BS**|**S**|**AP**|**D**|
|---|---|---|---|---|---|---|
|Hellstrike missile battery **[ANTI-FLY 4+]**|72"|4|3+|8|-2|3|
|Lascannon|48"|1|3+|12|-3|D6+1|
|Thunderhawk heavycannon**[BLAST]**|48"|D6+6|3+|10|-2|3|
...
KEYWORDS: **Vehicle, Titanic, Fly, Frame, Transport, Imperium, Thunderhawk Gunship**
