> Source: Imperial Agents, p.17 (eng_11-06_warhammer40000_faction_pack_imperial_agents-qhp2xzepry-gapdknla3x.pdf)

# WARHAMMER L E G E N D S

**Profile (stats):**
- M 6", T 3, SV 4+, W 4, LD 6+, OC 1
- Invulnerable Save: 4+
...
|**RANGED WEAPONS**|**RANGE**|**A**|**BS**|**S**<br>**AP**|**D**|
|---|---|---|---|---|---|
|Heirloompistol**[ANTI-INFANTRY 4+, PISTOL]**|12"|1|3+|4<br>-1|3|
|**MELEE WEAPONS**|**RANGE**|**A**|**WS**|**S**<br>**AP**|**D**|
|Monomolecular rapier**[SUSTAINED HITS 1]**|Melee|4|3+|3<br>-2|1|
