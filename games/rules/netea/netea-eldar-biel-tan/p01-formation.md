> Source: Netea Eldar Biel Tan, p.1 (netea-eldar-biel-tan-2026-02-03.pdf)

# Formation:

Eldar - Biel-Tan - 2026-02-03

# **ELDAR BIEL-TAN CRAFTWORLD ARMY LIST** 1
...
The Eldar Biel-Tan Craftworld Army List uses the datasheets from the Eldar Forces section.
...
The _Hit & Run Tactics_ rule applies to all Eldar formations (see _Hit & Run Tactics_ ). Additionally, certain units and weapons have special abilities described in _Farsight_ (see _Farsight_ ) and _Eldar Technology_ (see _Eldar Technology_ ).

1. Eldar Biel-Tan Craftworld Army List
