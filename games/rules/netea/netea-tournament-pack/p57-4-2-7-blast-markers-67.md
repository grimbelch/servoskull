> Source: Netea Tournament Pack, p.57 (netea-tournament-pack-2026-02-09.pdf)

# 4.2.7 Blast Markers 67

NetEA Tournament Pack - 2026-02-09

Aerospace Operations

#### **4.2.7 Blast Markers**<sup>67</sup>
...
The spacecraft of the 41<sup>st</sup> Millennium are huge. Even a small Imperial Lunar class Cruiser would be over 5 metres long if we made an Epic scale model of it. Because of this neither side is allowed to include more than one spacecraft in their army.
...
#### **4.3.1 Planning Spacecraft Operations**<sup>68</sup>
...
In addition to saying when the spacecraft will arrive, you must secretly record the drop zone for units entering play using the planetfall ability, (see 4.4) and also where any orbital bombardments will fall. Each player needs to do this in turn while the other player is not looking.
...
#### **4.3.2 Carrying Out The Operation**<sup>69</sup>

Spacecraft operations take place in the action phase of the turn.

67. 4.2.7 Blast Markers

Q: Do aircraft get a Blast marker for failing an activation?

A: No.

68. 4.3.1 Planning Spacecraft Operations

- Q: Do all units with planetfall have to have the same drop zone?

- A: No, you just need one drop zone for each formation entering play via planetfall.
