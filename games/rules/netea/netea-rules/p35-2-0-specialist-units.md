> Source: Netea Rules, p.35 (netea-rules-2026-02-05.pdf)

# 2.0 SPECIALIST UNITS &
...
_"We're safe 'ere Gobbitz. There's no way da beakies can get to us at the top of dis cliff..."_

_Last words of Gibli the Gretchin before being overrun by Space Marine Assault troops from the Salamanders Chapter_
...
Some units have special abilities that allow them to "buck the rules" in some way. This is usually because the units themselves are unusual due to their training, equipment or temperament. Any special abilities that apply to a unit will be noted on its datasheet (see 1.1.3).
...
- A: No. Duplicated abilities (from characters being added to the unit, for example) should be treated as occurring once.

- Q: Can units being transported use their special abilities? A: Yes.
...
- Q: Can units that are in a broken formation use their special abilities. A: Yes.
